class Project5 {
    public static void main(String args[]){
        /*
        This is an enhancement to Project 3; now with parameters! The result is a more
        modular approach to the problems posed.
        ...
        You solutions will be tested with varying values so make sure to leverage the parameters passed in!
        */
